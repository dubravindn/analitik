...
# На БАЗЕ обычную порчу оформляют не товарным документом loss, а расходным
# кассовым/банковским документом. Эти статьи переклассифицируются из
# операционных расходов в «Списания», чтобы не учитывать одну сумму дважды.
CASHFLOW_WRITEOFF_ITEMS: list[str] = ["Списание"]
